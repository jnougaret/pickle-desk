...
Tournament Desk is a Tauri Win32 desktop app. The Store package wraps the
...
After reserving the `Tournament Desk` product name, run:
...
`src-tauri/target/release/tournament-desk.exe` and writes the ignored package
