...
{#if !tournament}
  <main class="home-shell">
    ...
    <section class="home-hero">
      <div class="home-heading"><img class="home-logo" src={pickleToolsImage} alt="Pickle Tools mascot" /><h1>Pickle Tools</h1></div>
